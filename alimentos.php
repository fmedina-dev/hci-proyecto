...
//reanudamos la sesion que se creo para el usuario
	...
	WHERE producto_categoria_id=1")->fetchAll(PDO::FETCH_OBJ);
...
<section class="main">
		<div class="wrapp">
			...
			<div class="mensaje">
				...
				<a class="miga-no">/</a>
				<a href="categorias.php" class="miga"> Categorias</a>
				<a class="miga-no">/</a>
				<a class="miga-no"> Alimentos</a>
			</div>
					
			<div class="login-box-2">
												
				<h1 class="subtitulo">Categoría Alimentos</h1>
